      ...
      PROMPTS.map((prompt, i) =>
        rfetch(`/models/${MODEL}/predictions`, {
          ...
          body: JSON.stringify({
            // seedance-2.0 inputs
            input: {
              image: thumbnailUrl, // first frame
              last_frame_image: thumbnailUrl, // start == end -> seamless loop
              prompt,
              seed: i,
              duration: 4,
              resolution: "480p",
